...
const SavedMovies = ({
  ...
  const handleShortFilter = () => {
    ...
    localStorage.setItem('shortMovie', JSON.stringify(!isShortie));
  }
    ...
    <>
      <Header loggedIn={loggedIn} />
        <main className='content'>
          ...
          <MoviesCardList movies={displayMovies} deleteSaved={deleteSaved} onSave={undefined} isMovieSaved={undefined} />
        </main>
      <Footer />
    </>
  );
